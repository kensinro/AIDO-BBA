...
METABRIC_GE_PATH = Path(
    r"D:\AIDO-Data\External\brca_metabric\data_mrna_illumina_microarray.txt"
)

METABRIC_CLINICAL_PATH = Path(
    r"D:\AIDO-Data\External\brca_metabric\brca_metabric_clinical_data.tsv"
)
